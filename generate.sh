...
command_error_exit git clone https://github.com/jujimeizuo-yin/jujimeizuo.git
command_error_exit cp jujimeizuo/Makefile .
command_error_exit cp -rf jujimeizuo/template/* .
command_error_exit cp -rf jujimeizuo/template/* .
