#ifndef __JUJIMEIZUO_HTTP_SERVLET_H__
#define __JUJIMEIZUO_HTTP_SERVLET_H__
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (jujimeizuo::http::HttpRequest::ptr request
                   , jujimeizuo::http::HttpResponse::ptr response
                   , jujimeizuo::http::HttpSession::ptr session)> callback;
...
public:
    ...
    /**
     * @brief 添加模糊匹配servlet
     * @param[in] uri uri 模糊匹配 /jujimeizuo_*
