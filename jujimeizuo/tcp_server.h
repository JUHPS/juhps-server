#ifndef __JUJIMEIZUO_TCP_SERVER_H__
#define __JUJIMEIZUO_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(jujimeizuo::IOManager* io_woker = jujimeizuo::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(jujimeizuo::Address::ptr addr);
