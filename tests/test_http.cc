...
void test_http_request() {
    jujimeizuo::http::HttpRequest req;
    req.setMethod(jujimeizuo::http::HttpMethod::GET);
    req.setVersion(0x11);
    req.setPath("/search");
...
void test_http_response() {
    jujimeizuo::http::HttpResponse rsp;
    rsp.setStatus(jujimeizuo::http::HttpStatus::OK);
