...
void test_request(const char *str) {
    jujimeizuo::http::HttpRequestParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        jujimeizuo::http::HttpRequest::ptr req = parser.getData();
        std::cout << req->toString() << std::endl;
    }
}

void test_response(const char *str) {
    jujimeizuo::http::HttpResponseParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        jujimeizuo::http::HttpResponse::ptr rsp = parser.getData();
