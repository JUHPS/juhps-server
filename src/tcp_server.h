...
public:
     ...
     */
    TcpServer(jujimeizuo::IOManager* worker = jujimeizuo::IOManager::GetThis()
              ,jujimeizuo::IOManager* io_woker = jujimeizuo::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(jujimeizuo::Address::ptr addr, bool ssl = false);
