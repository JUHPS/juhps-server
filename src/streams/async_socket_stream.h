...
public:
    void setWorker(jujimeizuo::IOManager* v) { m_worker = v;}
    jujimeizuo::IOManager* getWorker() const { return m_worker;}

    void setIOManager(jujimeizuo::IOManager* v) { m_iomanager = v;}
    jujimeizuo::IOManager* getIOManager() const { return m_iomanager;}
...
protected:
    ...
    bool waitFiber();
protected:
    jujimeizuo::FiberSemaphore m_sem;
    jujimeizuo::FiberSemaphore m_waitSem;
    ...
    jujimeizuo::IOManager* m_iomanager;
    jujimeizuo::IOManager* m_worker;
