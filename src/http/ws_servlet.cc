...
int32_t FunctionWSServlet::onConnect(jujimeizuo::http::HttpRequest::ptr header
                                     ,jujimeizuo::http::WSSession::ptr session) {
    if(m_onConnect) {
...
int32_t FunctionWSServlet::onClose(jujimeizuo::http::HttpRequest::ptr header
                                     ,jujimeizuo::http::WSSession::ptr session) {
    if(m_onClose) {
...
int32_t FunctionWSServlet::handle(jujimeizuo::http::HttpRequest::ptr header
