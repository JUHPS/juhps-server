...
int32_t FunctionServlet::handle(jujimeizuo::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("jujimeizuo/1.0"));
}

int32_t ServletDispatch::handle(jujimeizuo::http::HttpRequest::ptr request
               , jujimeizuo::http::HttpResponse::ptr response
               , jujimeizuo::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(jujimeizuo::http::HttpRequest::ptr request
                   , jujimeizuo::http::HttpResponse::ptr response
                   , jujimeizuo::http::HttpSession::ptr session) {
    response->setStatus(jujimeizuo::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "jujimeizuo/1.0.0");
