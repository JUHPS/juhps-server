#ifndef __SRC_SOCKET_H__
#define __SRC_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(jujimeizuo::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(jujimeizuo::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(jujimeizuo::Address::ptr address);
