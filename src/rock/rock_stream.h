...
class RockStream : public jujimeizuo::AsyncSocketStream {
public:
    typedef std::shared_ptr<RockStream> ptr;
    typedef std::function<bool(jujimeizuo::RockRequest::ptr
                               ,jujimeizuo::RockResponse::ptr
                               ,jujimeizuo::RockStream::ptr)> request_handler;
    typedef std::function<bool(jujimeizuo::RockNotify::ptr
                               ,jujimeizuo::RockStream::ptr)> notify_handler;
...
protected:
    ...
    void handleRequest(jujimeizuo::RockRequest::ptr req);
    void handleNotify(jujimeizuo::RockNotify::ptr nty);
private:
...
public:
    ...
    RockConnection();
    bool connect(jujimeizuo::Address::ptr addr);
};
